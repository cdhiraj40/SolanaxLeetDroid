                ...
                <div className='social-media-wrap'>
                    ...
                    <div className='social-icons'>
                        ...
                        <Link className='social-icon-link github' to='/' aria-label='GitHub' onClick={() => {
                            window.open('https://github.com/cdhiraj40')
                        }}>
